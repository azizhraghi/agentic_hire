...
# =====================================================================
# BASE AGENT CLASS (same as student espace)
# =====================================================================

class RecruiterBaseAgent:
    """Base class for recruiter AI agents - SUPPORTS MISTRAL, HUGGINGFACE, OR GEMINI"""
...
class JobDescriptionAgent(RecruiterBaseAgent):
...
class AILinkedInPostAgent(RecruiterBaseAgent):
...
class CVScorerAgent(RecruiterBaseAgent):
...
class InterviewPlannerAgent(RecruiterBaseAgent):
...
class RecruiterCoordinator(RecruiterBaseAgent):
